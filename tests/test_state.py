"""Unit tests for flint_discord.state — BotState serialization, rehydration, dedup tracking."""
...
class TestBotStateSave:
    @patch("flint_discord.state.STATE_FILE")
...
class TestRehydrate:
    @patch("flint_discord.state.STATE_FILE")
    @patch("flint_discord.state.api_get", new_callable=AsyncMock)
